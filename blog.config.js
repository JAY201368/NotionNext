...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1d33690b3830808eb942dbc8921ffc62',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JAY', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Because textbooks shouldn’t require an archaeologist to decipher--welcome to readable software engineering.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-353pmh21m-jays-projects-ab02da23.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'JAY\'s personal blog', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Fate is kind to let our journeys intertwine again 🎉',
